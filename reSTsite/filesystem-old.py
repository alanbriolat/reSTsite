...
def visible_dir_filter(d):
    """Check if a directory path is visible.
    
    Return False if a directory should be hidden.  A directory is considered
...
class FS:
    ...
    def _walk(self):
        for root, dirs, files in os.walk(self.root):
            ...
            dirs[:] = filter(visible_dir_filter, dirs)
